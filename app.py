...
MODEL_SCRIPT = "llama-3.3-70b-versatile"
...
def get_realtime_info(query):
    ...
    # Refine & summarize the content via Groq
    prompt = f"""
...
"""
    try:
        ...
        return response.choices[0].message.content.strip() if response else "⚠️ Could not generate video script."
    except Exception as e:
